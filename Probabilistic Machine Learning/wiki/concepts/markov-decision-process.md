...
## Exam notes
- **Scope restriction:** For Week 9, only multi-armed bandits and Q-learning are directly examinable. MDP concepts are relevant only as the foundation for Q-learning.
- MDP components and Markov property: understand them for Q-learning.
- Bellman equation for $Q^*$: ⚠️ *No formula given in exam* (must know for Q-learning).
