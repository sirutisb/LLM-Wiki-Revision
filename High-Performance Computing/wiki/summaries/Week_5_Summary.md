...
*   **[Floating Point Representation](../concepts/Floating_Point_Arithmetic.md):** Understanding base, precision, significand (mantissa), and exponent.
...
*   **[Peak Performance ($R_{peak}$)](../concepts/Floating_Point_Arithmetic.md):** Calculating the theoretical maximum performance of a compute node or cluster based on clock frequency, core counts, and operations per cycle.